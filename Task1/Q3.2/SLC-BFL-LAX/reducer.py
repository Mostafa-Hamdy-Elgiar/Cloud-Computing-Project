...
for row in sys.stdin:
	...
	if org_dest == 'SLC-BFL' and dep_time and int(dep_time) < 1200 :
		output_dic_1[flight_number] = float(Arr_delay)
	if org_dest == 'BFL-LAX' and dep_time and  int(dep_time) > 1200 :
...
print "SLC-BFL-LAX : " + output_dic_1[0][0] +','+output_dic_2[0][0]
