...
for row in sys.stdin:
	...
	if org_dest == 'DFW-ORD' and dep_time and int(dep_time) < 1200 :
		output_dic_1[flight_number] = float(Arr_delay)
	if org_dest == 'ORD-DFW' and dep_time and  int(dep_time) > 1200 :
...
print "DFW-ORD-DFW : " + output_dic_1[0][0] +','+output_dic_2[0][0]
